  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update() {
        ...
        this.life++;
        if (this.life < 40)
          this.opacity = (this.life / 40) * this.targetOpacity;
        else if (this.life > this.maxLife - 40)
          this.opacity = ((this.maxLife - this.life) / 40) * this.targetOpacity;
    ...
    class Orb {
      constructor() {
        ...
        this.hue = Math.random() > 0.5 ? accent : accentAlt;
      }
      update() {
        this.x += this.vx;
        this.y += this.vy;
      ...
      draw() {
        ...
        g.addColorStop(
          ...
          this.hue
            .replace(")", ",0.07)")
            .replace("rgb", "rgba")
            .replace("#6c63ff", "rgba(108,99,255,0.07)")
            .replace("#00d4aa", "rgba(0,212,170,0.05)"),
        );
