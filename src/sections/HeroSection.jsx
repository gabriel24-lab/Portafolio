  ...
  return (
    <section
      ...
      style={{
        ...
        display: "flex",
        alignItems: "center",
        padding: "80px clamp(16px,6vw,140px) 60px",
        position: "relative",
        overflow: "hidden",
      }}
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 260 }}>
          ...
          >
            <a
              href="/CV-Gabriel-Mejia-Silva.pdf"
              download="CV-Gabriel-Mejia-Silva.pdf"
              style={{
                display: "inline-flex",
                alignItems: "center",
                gap: 8,
            ...
            >
              <i className="bi bi-chat-dots" style={{ marginRight: 4 }} />{" "}
              {tx.hero.contact}
            </button>
          </div>
        </div>
          ...
          >
            <div
              style={{
                ...
                inset: -8,
                borderRadius: "50%",
                background: `conic-gradient(${accent}, ${accentAlt}, ${accent})`,
